namespace GitterClient
{
    ...
    public sealed partial class App
    {
        ...
        protected async override void OnActivated(IActivatedEventArgs e)
        {
            ...
            {
                var scenarioFrame = MainPage.Current.FindName("ScenarioFrame") as Frame;
                if (scenarioFrame != null)
                {
                    // Call ContinuationManager to handle continuation activation
                    _continuationManager.Continue(continuationEventArgs, scenarioFrame);
                }
            }
        ...
        /// <summary>
        /// The restore status async.
        /// </summary>
        /// <param name="previousExecutionState">
